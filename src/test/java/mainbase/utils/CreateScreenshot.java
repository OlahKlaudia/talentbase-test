...
public class CreateScreenshot {
    private static final String SCREENSHOT_FOLDER = "." + File.pathSeparator + "target"+ File.pathSeparator +"screenshots\\"+ File.pathSeparator ;
    ...
    public void createScreenshotWhenFailTest(WebDriver driver) {
        ...
        Date date = new Date();
        try {
            FileUtils.copyFile(srcFile, new File( SCREENSHOT_NAME +  dateFormat.format(date) + ".png" ));
