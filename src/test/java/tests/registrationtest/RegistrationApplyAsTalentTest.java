...
public class RegistrationApplyAsTalentTest extends TalentbaseTestBase {
    ...
    public RegistrationHireTalentPage registration(){return new RegistrationHireTalentPage(getDriver());}
    public RegistrationApplyAsTalentPage registrationAsTalent(){return new RegistrationApplyAsTalentPage(getDriver());}
    @Test
